# A CNN model has much less parameters, however, which is not fit for the case study problem
...
class Cnn:
	...
	def md(self):
		...
		self.m = Sequential([
			Conv2D(4, (3, 3), padding='same', input_shape=input_size, activation='relu'),
