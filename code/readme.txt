To run the code, 
please install requried lib and 
use your own image data and put into the corresponding folder.
...
# Image data
Please use your own image data for running. (No image data is provided)
